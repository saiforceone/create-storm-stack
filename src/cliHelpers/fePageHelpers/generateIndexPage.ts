...
// Generated by the ST🌀RM Stack 2023-12-17
// core imports
...
<template>
  <div class="w-full min-h-screen flex flex-col bg-gradient-to-b from-bg-blue-200 to-strm-bg-lighter p-2">
            ...
            <div class="table w-full">
              ...
              <div class="table-row-group">
                <div class="table-row">
                  ...
                  <div class="table-cell"><span :class="commonSpanStyle">${componentName}</span></div>
                </div>
              </div>
            </div>
          </details>
      ...
      <section class="mt-4">
        ...
        <div class="p-1">
          <details :class="commonDetailStyle">
            ...
            edit this component in <span :class="commonSpanStyle">strm_fe_vue/src/pages/Storms/Index.vue</span>
          </details>
        </div>
      </section>
      <section class="mt-4">
        ...
        <div class="">
          <details :class="commonDetailStyle">
            ...
            <p class="text-lg">edit the corresponding model file in <span
              :class="commonSpanStyle">strm_models/storm.py</span></p>
          </details>
        </div>
        <div class="">
          <details :class="commonDetailStyle">
            <summary :class="commonSummaryStyle">Edit the Controller</summary>
            edit the corresponding controller file in <span
            :class="commonSpanStyle">strm_controllers/storm_controller.py</span>
          </details>
        </div>
      </section>
    </div>
